...
<div class="container-fluid my-4">
    <div class="row" id="page1">
        ...
        <div class="col-md-6 d-flex flex-column justify-content-center" style="background-color: black;color:white">
            <h4><?= htmlspecialchars($product['name']) ?></h4><br>
            <div style="max-width: 600px;font-size: 18px;">
                <p><?= nl2br(htmlspecialchars($product['description'])) ?></p>
            </div>
            <p style="color:#4caf50;font-size: 27px;"><?= number_format($product['price'], 0, ',', '.') ?>đ</p>
            <div class="d-flex align-items-center gap-3 mt-3">
                ...
                <button class="btn btn-secondary btn-sm" style="padding: 8px 14px; font-size: 1rem;">+</button>
                <button class="btn btn-success btn-sm" style="padding: 8px 14px; font-size: 1rem;"><i class="fa-solid fa-cart-plus fa-xl"></i></button>
